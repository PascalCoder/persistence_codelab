...
public interface BookDao {
    ...
    LiveData<List<Book>> findBooksBorrowedByUserAsync(String userName);
    ...
    @Query("SELECT * FROM Book " +
            ...
            "INNER JOIN User ON User.id = Loan.user_id " +
            "WHERE User.name LIKE :userName " +
            "AND Loan.endTime <= :before")
    public LiveData<List<Book>> findBooksReturnedByNameAfter(String userName, Date before); //added 4/3/19
}
